...
import { User, Building2, Shield, CreditCard, Users, Globe } from 'lucide-react';
      ...
      <DialogContent className="max-w-4xl h-[85vh] sm:h-[80vh] max-h-[90vh] w-[95vw] sm:w-full flex flex-col mx-4">
        <DialogHeader className="flex-shrink-0 pb-4">
          ...
          <DialogDescription className="text-sm sm:text-base">
            Manage your profile, organization, team members, subscription, custom domains, and privacy settings
          </DialogDescription>
        </DialogHeader>
        
        <Tabs defaultValue="profile" className="flex-1 flex flex-col min-h-0">
          <TabsList className="grid w-full grid-cols-6 flex-shrink-0 h-auto">
            ...
            <TabsTrigger value="domains" className="flex flex-col sm:flex-row items-center gap-1 sm:gap-2 p-2 sm:p-3 text-xs sm:text-sm">
