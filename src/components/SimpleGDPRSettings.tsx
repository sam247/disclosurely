    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="text-center p-4 bg-green-50 rounded-lg">
              ...
              <p className="text-sm text-green-600">Instant download available</p>
            </div>
            <div className="text-center p-4 bg-red-50 rounded-lg">
              <UserX className="h-8 w-8 text-red-600 mx-auto mb-2" />
              <h4 className="font-medium text-red-800">Account Deletion</h4>
              <p className="text-sm text-red-600">Complete within 24 hours</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button onClick={handleDataExport} disabled={loading || !exportEmail}>
              ...
              <AlertDialogHeader>
                ...
                <AlertDialogDescription className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 mt-4 p-3 bg-yellow-50 rounded-lg">
                    ...
                    <p className="text-sm">Deletion will be completed within 24 hours. You will be signed out immediately.</p>
                  </div>
