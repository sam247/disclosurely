...
const LinkGenerator = () => {
  ...
  const createLinkMutation = useMutation({
    mutationFn: async (newLink: {
      ...
      // The link_token will be auto-generated by the database trigger
      const { error } = await supabase
        ...
        .insert({
          ...
          department: newLink.department || null,
          location: newLink.location || null,
          usage_limit: newLink.usage_limit,
          expires_at: newLink.expires_at,
          is_active: newLink.is_active,
          link_token: '' // This will be auto-generated by the database trigger
        });
