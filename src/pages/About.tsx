  ...
  return (
    <>
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 mb-6">Who we are</h1>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">{t("about.hero.description")}</p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <Card className="text-white p-8 rounded-2xl bg-blue-600">
              <h3 className="text-3xl font-bold mb-4">
                On a Mission to Make Whistleblowing Easier, Safer, and More Effective!
              </h3>
              <p className="text-lg text-gray-200 leading-relaxed">
                {t("about.mission.content") ||
                  "At Disclosurely, we’re redefining how businesses handle ethics and compliance. Our mission is simple — to help organisations save time, reduce risk, and cut costs by making anonymous reporting faster, more secure, and easier for employees to adopt. We believe transparency shouldn’t be complicated. By empowering employees to speak up with confidence, we help companies detect issues early, prevent costly risks, and build stronger cultures of trust and accountability."}
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Our success by the numbers</h2>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-12 text-center">Our company's values</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <Card className="p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Military-grade AES-GCM encryption ensures that every report is protected with the highest security
                standards. Your data is encrypted at rest and in transit, with zero-knowledge architecture.
              </p>
            </Card>
            ...
            <Card className="p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <p className="text-gray-600">
                Streamlined workflows connect your team seamlessly. Built-in case management, real-time notifications,
                and AI-powered insights help you resolve issues faster and more effectively.
              </p>
            </Card>
            ...
            <Card className="p-8 rounded-2xl hover:shadow-lg transition-shadow">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-4">Instant Compliance</h3>
              <p className="text-gray-600">
                Automated compliance reporting built for GDPR, SOX, ISO 27001, and more. Stay audit-ready with
                comprehensive reporting tools and dashboard analytics.
              </p>
            </Card>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-6">Intuitive Dashboard</h2>
              <p className="text-lg text-gray-600 mb-8">
                Our comprehensive dashboard provides real-time insights into your reporting activities. Track case
                resolution times, monitor trends, and manage your compliance requirements all from one central location.
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      Monitor case status, assignment, and resolution progress with our comprehensive case management
                      system.
                    </p>
                  </div>
                </div>
      ...
      <section className="py-16 px-4 sm:px-6 lg:px-8 bg-blue-600">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              <h2 className="text-4xl font-bold text-white mb-6">Build a culture of trust and compliance</h2>
