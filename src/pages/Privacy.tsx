          ...
          <div className="prose prose-gray max-w-none space-y-8">
            <div className="bg-blue-50 p-6 rounded-lg border border-blue-200">
              <div className="space-y-2 text-sm">
                <p><strong>{t('privacy.info.effectiveDate.label')}</strong> {t('privacy.info.effectiveDate.value')}</p>
                <p><strong>{t('privacy.info.company.label')}</strong> {t('privacy.info.company.value')}</p>
                <p><strong>{t('privacy.info.website.label')}</strong> <a href="https://disclosurely.com" className="text-blue-600 hover:text-blue-800">https://disclosurely.com</a></p>
                <p><strong>{t('privacy.info.contact.label')}</strong> <a href="mailto:support@disclosurely.com" className="text-blue-600 hover:text-blue-800">support@disclosurely.com</a></p>
                <p><strong>{t('privacy.info.office.label')}</strong> {t('privacy.info.office.value')}</p>
              </div>
            </div>
            ...
            <section>
              ...
              <div className="text-gray-700 leading-relaxed space-y-4">
                ...
                <div>
                  <h3 className="font-medium mb-2">{t('privacy.sections.personalData.subsections.whistleblower.title')}</h3>
                  <ul className="list-disc pl-6 space-y-1">
            ...
            <section>
              ...
              <div className="text-gray-700 leading-relaxed">
                ...
                <ul className="list-disc pl-6 space-y-1">
                  <li><strong>{t('privacy.sections.legalBases.items.contractual.label')}</strong> {t('privacy.sections.legalBases.items.contractual.content')}</li>
                  <li><strong>{t('privacy.sections.legalBases.items.legitimate.label')}</strong> {t('privacy.sections.legalBases.items.legitimate.content')}</li>
                  <li><strong>{t('privacy.sections.legalBases.items.legal.label')}</strong> {t('privacy.sections.legalBases.items.legal.content')}</li>
                  <li><strong>{t('privacy.sections.legalBases.items.consent.label')}</strong> {t('privacy.sections.legalBases.items.consent.content')}</li>
                </ul>
              </div>
            </section>
