---
title: File Uploads & Evidence Management | Disclosurely
description: Securely upload documents, images, videos, and audio files as evidence for whistleblowing reports. Support for 50+ file types with automatic metadata stripping and virus scanning.
head:
  - - meta
    - property: og:title
      content: File Uploads & Evidence Management - Disclosurely
  - - meta
  ...
  - - meta
    - name: twitter:title
      content: File Uploads & Evidence - Disclosurely
  - - meta
    - property: og:description
      content: Securely upload documents, images, videos, and audio files as evidence for whistleblowing reports. Support for 50+ file types with automatic metadata stripping and virus scanning.
  - - meta
...
**Chunked Upload:**
Large files upload in chunks to prevent timeout:
...
**Multiple Files:**
Upload up to 20 files simultaneously. Total report limits still apply.
...
**Metadata Report:**
Shows detected metadata categories:
...
- Provide file hash or description
- Manual review possible
- Whitelist if confirmed safe
...
Files can be reviewed entirely in browser without downloading.
