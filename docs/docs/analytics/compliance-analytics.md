...
**Acceptable**: 100% within 6 months for complex cases
...
**Target**: 100% compliance
**Regulatory Requirement**: GDPR Article 12(3)
...
**Target**: < 60 days (early detection)
**Concern**: > 180 days (late detection or underreporting)
...
**Frequency**: Monitor weekly, report quarterly
...
**Frequency**: Monitor monthly, report quarterly
...
**Frequency**: Monitor monthly, report quarterly to audit committee
...
**Lagging Indicators**: Tell you what already happened (e.g., cases closed, substantiation rate)
**Leading Indicators**: Predict future outcomes, enable proactive intervention
...
**Lagging**: Retaliation rate last year was 3%
**Leading**: Employment status monitoring shows concerning patterns for 2 recent reporters (intervene proactively)
